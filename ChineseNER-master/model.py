...
from data_utils import create_input, iobes_iob,iob2
    ...
    def evaluate(self, sess, data_manager, id_to_tag):
        ...
        for batch in data_manager.iter_batch():
            ...
            for i in range(len(strings)):
                ...
                gold = iob2([id_to_tag[int(x)] for x in tags[i][:lengths[i]]])
                #pred = iobes_iob([id_to_tag[int(x)] for x in batch_paths[i][:lengths[i]]])
                pred = iob2([id_to_tag[int(x)] for x in batch_paths[i][:lengths[i]]])
